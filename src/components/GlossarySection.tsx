...
const ENTRIES: GlossaryEntry[] = [
  ...
  {
    photoFigure: true,
    term: 'Stator — Dimensions Di, De, h et encoches (vue 3D)',
    definition: "Vue 3D annotée d'un stator bobiné montrant toutes les dimensions clés à mesurer pour le calcul de la section totale des encoches :\n\n• Di — Diamètre Intérieur : diamètre de l'alésage central du stator (où tourne le rotor). Se mesure face au stator avec le pied à coulisse sur les mâchoires intérieures.\n\n• De — Diamètre Extérieur : diamètre extérieur du noyau feuilleté. Se mesure sur le corps cylindrique du stator.\n\n• h — Hauteur de l'encoche : profondeur radiale d'une encoche depuis le fond jusqu'à l'ouverture côté alésage. Se mesure sur la coupe A-A ou directement dans une encoche vide.\n\n• N — Nombre d'encoches : compter le nombre total d'encoches réparties sur le pourtour intérieur du stator.\n\nLa coupe A-A (bas gauche) illustre la relation entre Di, De et h dans la section transversale.",
    formula: 'A_encoches = N × ((De - Di) / 2) × h\nExemple : N=36, Di=90, De=150, h=35 → A = 9450 mm²',
    typical: 'Di : 60–300 mm | De : 100–500 mm | h : 15–50 mm | N : 24–72 encoches',
    diagram: <img src="/images/6f0938c3-4083-4f4f-a0a6-bde0fd459904.png" alt="Stator 3D — Di, De, h, encoches et bobinages" className="w-full h-full object-contain rounded-lg" />,
    contexts: ['stator'],
  },
  {
    photoFigure: true,
    term: 'Stator — Coupe transversale et mesures des encoches',
    definition: "Vue en coupe et vues complémentaires d'un stator bobiné pour comprendre comment prendre les mesures avec précision :\n\n• Vue principale (3D coupe) : montre le noyau en tôles ferromagnétiques (laminations), les encoches avec bobinage cuivre, et les fils de sortie. Les flèches indiquent Di (bleu), De (rouge) et h (vert).\n\n• Vue de dessus : disposition des N encoches sur le pourtour. Permet de compter facilement le nombre total d'encoches (N = 1, 2, 3 … N).\n\n• Détail d'une encoche : largeur (W), profondeur (p) et hauteur (h). La hauteur h est la cote à mesurer pour la formule de surface.\n\n• Coupe transversale (bas droite) : section du stator montrant Di, De et h dans leur contexte géométrique exact. Correspond au schéma de calcul : A = ((De − Di) / 2) × h par encoche.\n\n• Vue en coupe circulaire : coupe du stator complet avec les bobinages cuivre visibles dans chaque encoche.",
    formula: 'A_encoches = N × ((De - Di) / 2) × h\nSection par encoche = ((De - Di) / 2) × h',
    typical: 'Rapport De/Di typique : 1,5 à 2,0 | h/Di typique : 0,15 à 0,30',
    diagram: <img src="/images/c4eeceb2-8e60-4395-96ba-c821cc65987e.png" alt="Stator coupe transversale — mesures Di, De, h encoches" className="w-full h-full object-contain rounded-lg" />,
    contexts: ['stator'],
  },
  {
    photoFigure: true,

    ...
    <div className="space-y-5">
      <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl">
        ...
        <p className="text-sm text-amber-700">
          Calculateur pour les bobines d'électrofrein et électroaimants. Entrez les dimensions du bobineau et les caractéristiques électriques, puis cliquez sur <strong>Calculer</strong>.
        </p>
      </div>
      ...
      <SectionPanel title="Caractéristiques Électriques" description="Tension et courant nominaux">
        ...
        <InputField label="Courant nominal" unit="A" value={inp.current} onChange={v => set('current', v)} min={0.001} step={0.01} hint="Courant à la résistance nominale" />
        ...
        <>
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200">
            <p className="text-xs text-slate-500">
              ...
              S = √(ρ × kf × A_bob × l_moy / R) &nbsp;|&nbsp;
              A_bobinage = {(((inp.outerDiameter - inp.innerDiameter) / 2) * inp.coilHeight).toFixed(1)} mm² &nbsp;|&nbsp;
              l_moy = {res.meanTurnLength.toFixed(1)} mm &nbsp;|&nbsp;
              ρ_Cu = 0,01724 Ω·mm²/m
            </p>
          </div>
        </>

...
export const COPPER_RESISTIVITY = 0.01724; // Ω·mm²/m at 20°C
export const COPPER_DENSITY = 8900; // kg/m³
...
export function findWireByDiameter(diameter: number): WireEntry | null {
  return WIRE_TABLE.find(w => Math.abs(w.diameter - diameter) < 0.005) ?? null;
}
